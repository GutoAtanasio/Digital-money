...
export default function Modal({ open, setOpen }) {
  ...
  // O tipo da transição, que pode ser "input" (entrada) ou "output" (saida)
      ...
      <Dialog open={open} onClose={setOpen} className="relative z-10">
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <div className={"px-4 pt-5 pb-4 sm:p-6 sm:pb-4 " + (darkMode ? "bg-slate-800" : "bg-white")}>
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                    <h1 className={"text-2xl font-bold mb-5 " + (darkMode ? "text-gray-900" : "text-white")}>
                      Cadastrar transação
                    </h1>
